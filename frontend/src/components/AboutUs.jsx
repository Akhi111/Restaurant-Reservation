  ...
  return (
    <div className=" border-b-2 border-b-[#2b610e] min-h-screen flex flex-col justify-center lg:flex-row lg:justify-between items-center lg:px-32 px-5 gap-10 bg-[#D9EDBF]">
      <div className=" w-full lg:w-2/4 space-y-4 mt-14 lg:mt-0">
        ...
        <p>
        <span className="font-bold text-[#2b4e18] text-xl drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">The only thing we are serious about is food.</span><br></br>
      ...
      <div className="relative">
        <div>
          <img
            src={img1}
            alt="img"
            className="h-auto max-w-xl rounded-2xl shadow-xl dark:shadow-gray-800 drop-shadow-xl"
          />
        </div>
      </div>
    </div>
